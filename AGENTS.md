...
- `collections` uses source set keys and normalized bare/painted item IDs. Its `unusuals` values are unresolved source loot-list names, not enumerated rare rewards or probabilities.
