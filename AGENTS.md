...
- `definitions.tradable = false` comes only from an explicit or inherited `cannot trade = 1` attribute. Omit it otherwise; absence does not establish tradability or Steam Market availability.
